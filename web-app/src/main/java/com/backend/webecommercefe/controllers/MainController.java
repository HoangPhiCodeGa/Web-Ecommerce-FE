...
public class MainController {
    ...
    private static final String CATEGORY_SERVICE_URL = "http://localhost:9898/api/categories";
    ...
    public String addProduct(
        ...
        try {
            ...
            request.put("mo_ta", moTa);
            request.put("gia_ban", giaBan);
            request.put("gia_nhap", giaNhap);
            request.put("gia_goc", giaGoc);
            request.put("so_luong", soLuong);
            request.put("mau_sac", mauSac != null ? mauSac : "");
            request.put("kich_co", kichCo != null ? kichCo : "");
    ...
    public String updateProduct(
        ...
        product.put("mo_ta", moTa);
        product.put("gia_ban", giaBan);
        product.put("gia_nhap", giaNhap);
        product.put("gia_goc", giaGoc);
        product.put("so_luong", soLuong);
        product.put("mau_sac", mauSac != null ? mauSac : "");
        product.put("kich_co", kichCo != null ? kichCo : "");
